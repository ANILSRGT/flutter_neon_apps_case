...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MetObjectsModel&&(identical(other.localId, localId) || other.localId == localId)&&(identical(other.total, total) || other.total == total)&&const DeepCollectionEquality().equals(other.objectIDs, objectIDs));
}
...
@override
String toString() {
  return 'MetObjectsModel(localId: $localId, total: $total, objectIDs: $objectIDs)';
}
...
class _MetObjectsModel implements MetObjectsModel {
  const _MetObjectsModel({@Id(assignable: true) this.localId, this.total, final  List<int>? objectIDs}): _objectIDs = objectIDs;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MetObjectsModel&&(identical(other.localId, localId) || other.localId == localId)&&(identical(other.total, total) || other.total == total)&&const DeepCollectionEquality().equals(other._objectIDs, _objectIDs));
}
