...
@Id(assignable: true) int? get localId;@Unique() int? get departmentId; String? get displayName;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DepartmentModel&&(identical(other.localId, localId) || other.localId == localId)&&(identical(other.departmentId, departmentId) || other.departmentId == departmentId)&&(identical(other.displayName, displayName) || other.displayName == displayName));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,localId,departmentId,displayName);

@override
String toString() {
  return 'DepartmentModel(localId: $localId, departmentId: $departmentId, displayName: $displayName)';
}
...
@useResult
$Res call({
@Id(assignable: true) int? localId,@Unique() int? departmentId, String? displayName
});
...
/// Create a copy of DepartmentModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? localId = freezed,Object? departmentId = freezed,Object? displayName = freezed,}) {
...
class _DepartmentModel implements DepartmentModel {
  const _DepartmentModel({@Id(assignable: true) this.localId, @Unique() this.departmentId, this.displayName});
...
@override@Unique() final  int? departmentId;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DepartmentModel&&(identical(other.localId, localId) || other.localId == localId)&&(identical(other.departmentId, departmentId) || other.departmentId == departmentId)&&(identical(other.displayName, displayName) || other.displayName == displayName));
}
...
/// Create a copy of DepartmentModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? localId = freezed,Object? departmentId = freezed,Object? displayName = freezed,}) {
