...
@Id(assignable: true) int? get localId; String? get term; String? get AAT_URL; String? get Wikidata_URL;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TagModel&&(identical(other.localId, localId) || other.localId == localId)&&(identical(other.term, term) || other.term == term)&&(identical(other.AAT_URL, AAT_URL) || other.AAT_URL == AAT_URL)&&(identical(other.Wikidata_URL, Wikidata_URL) || other.Wikidata_URL == Wikidata_URL));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,localId,term,AAT_URL,Wikidata_URL);

@override
String toString() {
  return 'TagModel(localId: $localId, term: $term, AAT_URL: $AAT_URL, Wikidata_URL: $Wikidata_URL)';
}
...
@useResult
$Res call({
@Id(assignable: true) int? localId, String? term, String? AAT_URL, String? Wikidata_URL
});
...
/// Create a copy of TagModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? localId = freezed,Object? term = freezed,Object? AAT_URL = freezed,Object? Wikidata_URL = freezed,}) {
...
class _TagModel implements TagModel {
  const _TagModel({@Id(assignable: true) this.localId, this.term, this.AAT_URL, this.Wikidata_URL});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TagModel&&(identical(other.localId, localId) || other.localId == localId)&&(identical(other.term, term) || other.term == term)&&(identical(other.AAT_URL, AAT_URL) || other.AAT_URL == AAT_URL)&&(identical(other.Wikidata_URL, Wikidata_URL) || other.Wikidata_URL == Wikidata_URL));
}
...
/// Create a copy of TagModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? localId = freezed,Object? term = freezed,Object? AAT_URL = freezed,Object? Wikidata_URL = freezed,}) {
