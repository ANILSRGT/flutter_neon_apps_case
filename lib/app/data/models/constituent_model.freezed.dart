...
mixin _$ConstituentModel {
 ...
 int? get constituentID; String? get role; String? get name; String? get constituentULAN_URL; String? get constituentWikidata_URL; String? get gender;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,constituentID,role,name,constituentULAN_URL,constituentWikidata_URL,gender);

@override
String toString() {
  return 'ConstituentModel(constituentID: $constituentID, role: $role, name: $name, constituentULAN_URL: $constituentULAN_URL, constituentWikidata_URL: $constituentWikidata_URL, gender: $gender)';
}
...
@useResult
$Res call({
 int? constituentID, String? role, String? name, String? constituentULAN_URL, String? constituentWikidata_URL, String? gender
});
...
/// Create a copy of ConstituentModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? constituentID = freezed,Object? role = freezed,Object? name = freezed,Object? constituentULAN_URL = freezed,Object? constituentWikidata_URL = freezed,Object? gender = freezed,}) {
  return _then(_self.copyWith(
constituentID: freezed == constituentID ? _self.constituentID : constituentID // ignore: cast_nullable_to_non_nullable
...
class _ConstituentModel implements ConstituentModel {
  const _ConstituentModel({this.constituentID, this.role, this.name, this.constituentULAN_URL, this.constituentWikidata_URL, this.gender});
  factory _ConstituentModel.fromJson(Map<String, dynamic> json) => _$ConstituentModelFromJson(json);

@override final  int? constituentID;
...
/// Create a copy of ConstituentModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? constituentID = freezed,Object? role = freezed,Object? name = freezed,Object? constituentULAN_URL = freezed,Object? constituentWikidata_URL = freezed,Object? gender = freezed,}) {
