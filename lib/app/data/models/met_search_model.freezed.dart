...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MetSearchModel&&(identical(other.total, total) || other.total == total)&&const DeepCollectionEquality().equals(other.objectIDs, objectIDs));
}
...
@override
String toString() {
  return 'MetSearchModel(total: $total, objectIDs: $objectIDs)';
}
...
class _MetSearchModel implements MetSearchModel {
  const _MetSearchModel({this.total, final  List<int>? objectIDs}): _objectIDs = objectIDs;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MetSearchModel&&(identical(other.total, total) || other.total == total)&&const DeepCollectionEquality().equals(other._objectIDs, _objectIDs));
}
